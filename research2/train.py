...
from models.mpcg_altc import PROMPT_MPCG_ALTC, MPCG_ALTC
...
def main():
    ...
    input_colses = {
        'prompt_mpcg_altc': ['prompt_bert_indices', 'prompt_segments_indices', 'mask_idx'],
        'mpcg_altc':  ['text_indices', 'segments_indices'],
    }
